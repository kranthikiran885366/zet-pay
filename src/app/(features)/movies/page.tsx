                               ...
                               <div className="flex flex-col items-center">
                                  {seatRows.map(row => (
                                     <div key={row} className="flex items-center gap-1 mb-1 w-full justify-center">
                                        ...
                                        <div className={`grid ${gridColsClass} gap-1.5 flex-grow justify-center items-center`}>
...
```xml
  <change>
    <file>src/app/(features)/movies/page.tsx</file>
    <description>Add authentication check before initiating booking in `handleConfirmBooking` to prevent errors when the user is not logged in.</description>
